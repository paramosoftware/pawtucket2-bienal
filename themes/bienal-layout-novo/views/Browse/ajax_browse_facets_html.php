...
<style>
	...
	#bMorePanel {padding:30px;background-color:var(--bienal_primary);position:fixed;top:70px;right:0px;width:100%;height:calc(100% - 70px);display:none;max-width:400px;font-size:0px}
