...
<link rel="stylesheet" type="text/css" href="<?=$this->request->getBaseUrlPath()?>/assets/bootstrap/css/bootstrap.css" />
			...
			?>
				<div id="links">
					<?php
						...
						{
						?>
							<a href="<?=$this->request->getBaseUrlPath()?>/index.php/Gallery/getSetInfo/set_id/<?php print $va_subset["set_id"]; ?>/parent/<?php print $vn_set_id; ?>"><?php print $va_subset["set_name"]; ?></a>
						<?php
						}
					?>
				</div>
